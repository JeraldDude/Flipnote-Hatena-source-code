...
Hatena.CSSChanger = new Ten.Class({
    ...
    change: function(name) {
        ...
        try { pageTracker._trackPageview('/csschanger/select_' + name) } catch(e) {}
    ...
    changeImages: function(name, ancestor) {
        if (name && !(name in this.cssFiles))
            return;
        ...
        change(ancestor.getElementsByTagName('img'));
        change(ancestor.getElementsByTagName('input'));
...
Hatena.CSSChanger.COOKIE_KEY = '_hatena_ugomemo_csschanger_name';
// require Ten.js
if (typeof Hatena == 'undefined')
    var Hatena = {};
...
Hatena.DropDownSelector = new Ten.Class({
    ...
    show: function(e) {
        if (e && e.stop) e.stop();
        try { pageTracker._trackPageview('/csschanger/show') } catch(e) {}
